...
//            let modelURL = NSBundle.mainBundle().URLForResource("conferenceMate", withExtension: "momd")
...
//            let storeURL = self.applicationDocumentsDirectory.URLByAppendingPathComponent("conferenceMate.sqlite")
//            var error: NSError? = nil
